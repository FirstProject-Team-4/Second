...
const isAdmin=false;
  ...
  return set(ref(db, `users/${handle}`), { handle, uid, email,firstName:'None',lastName:'None',phoneNumber:'None',bio:'None', createdOn: new Date().valueOf(),isAdmin,isBlock:false, likedPosts: {} })
};
